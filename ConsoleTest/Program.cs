    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine("-----------------------------------------------------------------------------------------------------------------");
                result = ServicioCliente.RegistrarPago(1, DateTime.Now, "COD", "MGT1234", "1020809963", "EmpresaSRL", "105", "demo", token,"DETALLE","FACTURA");
                Console.WriteLine(result);

                Console.WriteLine("-----------------------------------------------------------------------------------------------------------------");
                Console.WriteLine("Seleccionaste opcion 8 :  RevertirPago");
                Console.WriteLine("-----------------------------------------------------------------------------------------------------------------");
                result = ServicioCliente.RevertirPago(1, DateTime.Now, "102080909", "demo", token);
                Console.WriteLine(result);

                Console.WriteLine("-----------------------------------------------------------------------------------------------------------------");
                Console.WriteLine("Seleccionaste opcion 9 :  ExtornarFactura");
                Console.WriteLine("-----------------------------------------------------------------------------------------------------------------");
                result = ServicioCliente.ExtornarFactura(1, DateTime.Now, "10208099963", 90910, "demo", token);
                Console.WriteLine(result);

                Console.WriteLine("-----------------------------------------------------------------------------------------------------------------");
                Console.WriteLine("Seleccionaste opcion 10 :  ConsultarTransaccion");
                Console.WriteLine("-----------------------------------------------------------------------------------------------------------------");
                result = ServicioCliente.ConsultarTransaccion(1, DateTime.Now, "1008", "demo", token);
                Console.WriteLine(result);

                Console.WriteLine("-----------------------------------------------------------------------------------------------------------------");
                Console.WriteLine("Seleccionaste opcion 11 :  ObtenerDetallePagos");
                Console.WriteLine("-----------------------------------------------------------------------------------------------------------------");
                result = ServicioCliente.ObtenerDetallePagos(1, "COD", "MGT1234", DateTime.Now, DateTime.Now, "demo", token);
                Console.WriteLine(result);

                Console.WriteLine("-----------------------------------------------------------------------------------------------------------------");
                Console.WriteLine("Seleccionaste opcion 12 :  ObtenerDatosDeFactura");
                Console.WriteLine("-----------------------------------------------------------------------------------------------------------------");
                result = ServicioCliente.ObtenerDatosDeFactura(1, DateTime.Now, "1009", "demo", token);
                Console.WriteLine(result);
                ...
                Console.WriteLine("-----------------------------------------------------------------------------------------------------------------");
                result = ServicioCliente.ConciliarPagos(1, DateTime.Now, DateTime.Now, "usuarioPago", "demo", token);
                Console.WriteLine(result);
